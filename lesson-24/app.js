...
router.use((req, res, next) => {
  ...
  res.locals.loggedIn = req.isAuthenticated(); //passport 불린
...
const mongoose = require("mongoose");
  ...
  mongoose.connect(  
    "mongodb+srv://ut-node:ipo5XIzHIBQviwTS@ut-node.qkr65tx.mongodb.net/?retryWrites=true&w=majority&appName=ut-node",
  );
